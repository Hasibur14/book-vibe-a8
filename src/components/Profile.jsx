    ...
    return (
        <div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 ">
                <div className="flex flex-col  justify-center lg:w-96 p-6 shadow-md rounded-xl sm:px-12 bg-gray-400 text-gray-100">
                    <img src={image} alt="" className="w-32 h-32 mx-auto rounded-full bg-gray-500 aspect-square" />
                    <div className="space-y-4 text-center divide-y divide-gray-700">
                        <div className="my-2 space-y-1">
                            <h2 className="text-xl font-semibold sm:text-2xl">{authorName}</h2>
                            <p className="px-5 text-xs sm:text-base text-white">Writer</p>
                        </div>
